        ...
        <div className='xl:col-span-6 md:col-span-12 flex justify-center items-center'>
          <div className='text-center xl:text-start'>
            ...
            <div className='mt-8 flex items-center justify-center xl:justify-start'>
              <a href='https://drive.google.com/drive/u/0/folders/1ETtRiBr5I5aDfqRi7NwkiYTh4r4TuUqO' target='_blank' type="button" class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg z-10 text-sm px-5 py-2.5 text-center mr-2">
